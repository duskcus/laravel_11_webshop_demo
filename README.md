<h2>IMPORTANT Download the right 7zip release for each chapter and don't click source code as it gives you the github repo's code and as I'm still regularly updating/breaking the repository's code:</h2>
